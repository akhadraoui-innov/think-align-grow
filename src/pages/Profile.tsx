  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <div className="px-6 pt-12 pb-6">
        ...
        >
          ...
          <div className="flex flex-col gap-3 w-full max-w-xs">
            <Button
              size="lg"
              className="rounded-2xl bg-gradient-hero text-primary-foreground font-semibold"
      ...
      <div className="px-6 mt-8">
        <h2 className="font-display text-lg font-bold mb-4">Avec un compte, vous pouvez :</h2>
        {[
