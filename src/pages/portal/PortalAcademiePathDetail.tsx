        ...
        <div className={`bg-gradient-to-br ${diff.gradient} border-b`}>
          <div className="p-6 space-y-4">
            <div className="flex items-center gap-3">
              <Button variant="ghost" size="icon" onClick={() => navigate("/portal/academie/paths")} className="shrink-0">
            ...
            <div className="flex items-center gap-4 text-xs">
              {funcData && (
                <button onClick={() => navigate(`/portal/academie/functions/${funcData.id}`)} className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-background/60 hover:bg-background/90 transition-colors">
