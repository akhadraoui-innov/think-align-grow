...
import { Award, BarChart3, TrendingUp, Users, Search, ExternalLink, Copy, Code, Webhook, Key, BookOpen, Settings, LayoutDashboard, List, Plug, Ban } from "lucide-react";
...
export default function PortalAcademieCertificates() {
