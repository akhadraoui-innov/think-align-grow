                        ...
                        return (
                          <div key={idx} className="flex items-center gap-3 p-3 rounded-xl bg-muted/30 border border-border/50">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-1"><Progress value={mod.score} className="h-1 flex-1 max-w-[100px]" /><span className="text-[10px] font-semibold text-primary">{mod.score}%</span></div>
                            </div>
                            <div className="text-[10px] text-muted-foreground flex items-center gap-1 shrink-0"><Clock className="h-3 w-3" />{mod.time_minutes}min</div>
                          </div>
                        );
                      })}
                    </div>
