...
import { ArrowLeft, Award, Calendar, BookOpen, Trophy, Clock, FileText, HelpCircle, MessageSquare, Download, Copy, CheckCircle2, GraduationCap, BarChart3, Timer, Linkedin, Share2 } from "lucide-react";
...
export default function PortalFormationsCertificates() {
  ...
  // Generate QR for dialog preview
  useEffect(() => {
    if (selectedCert) {
        ...
        <div className="px-5 space-y-4">
          {isLoading ? (
            ...
            <Card className="border-dashed"><CardContent className="p-12 text-center">
              ...
              <Button onClick={() => navigate("/portal")} size="sm"><BookOpen className="h-4 w-4 mr-2" /> Explorer les parcours</Button>
            </CardContent></Card>
