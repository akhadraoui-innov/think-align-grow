      ...
      <div className="p-6 space-y-6">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filtered.map((f: any) => (
              <Card key={f.id} className="hover:shadow-md transition-all group cursor-pointer" onClick={() => navigate(`/portal/academie/functions/${f.id}`)}>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y">
                    {filtered.map((f: any) => (
                      <tr key={f.id} className="hover:bg-muted/50 cursor-pointer" onClick={() => navigate(`/portal/academie/functions/${f.id}`)}>
                        <td className="p-3">
