                ...
                <TableRow className="cursor-pointer" onClick={() => setExpandedId(isOpen ? null : q.id)}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-1" onClick={e => e.stopPropagation()}>
                      ...
                      <Button size="icon" variant="ghost" onClick={() => navigate(`/portal/academie/modules/${q.module_id}`)}><Pencil className="h-4 w-4" /></Button>
                    </div>
                  </TableCell>
                </TableRow>
                ...
                <TableRow className="cursor-pointer" onClick={() => setExpandedId(isOpen ? null : ex.id)}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-1" onClick={e => e.stopPropagation()}>
                      ...
                      <Button size="icon" variant="ghost" onClick={() => navigate(`/portal/academie/modules/${ex.module_id}`)}><Pencil className="h-4 w-4" /></Button>
                    </div>
                  </TableCell>
                </TableRow>
                <DetailRow expanded={isOpen} colSpan={8}>
                ...
                <TableRow className="cursor-pointer" onClick={() => setExpandedId(isOpen ? null : pr.id)}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-1" onClick={e => e.stopPropagation()}>
                      ...
                      <Button size="icon" variant="ghost" onClick={() => navigate(`/portal/academie/modules/${pr.module_id}`)}><Pencil className="h-4 w-4" /></Button>
                    </div>
                  </TableCell>
                </TableRow>
                <DetailRow expanded={isOpen} colSpan={8}>
