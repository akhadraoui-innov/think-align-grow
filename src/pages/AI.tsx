...
import { Sparkles, MessageSquare, FileText, Compass, Zap, ChevronRight, ArrowLeft } from "lucide-react";
          ...
          <div className="px-6 pt-10 pb-3 border-b border-border">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground uppercase tracking-wider">Mode conversation</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Utilisez les outils IA</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="px-6 space-y-3">
          {aiTools.map((tool, i) => (
            <motion.div
              ...
              className="rounded-3xl bg-card border border-border p-5 cursor-pointer hover:border-primary/20 hover:shadow-lg hover:shadow-primary/5 transition-all duration-200 relative overflow-hidden group active:scale-[0.98]"
            >
