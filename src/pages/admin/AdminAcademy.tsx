...
export default function AdminAcademy() {
  ...
  const quickLinks = [
    { label: "Cartographie", desc: "Vue relationnelle", icon: Map, path: "/admin/academy/map" },
    { label: "Fonctions", desc: `${functions.length} rôles`, icon: Briefcase, path: "/admin/academy/functions" },
    { label: "Personae", desc: `${personae.length} profils`, icon: UserCircle, path: "/admin/academy/personae" },
    { label: "Parcours", desc: `${paths.length} formations`, icon: Route, path: "/admin/academy/paths" },
    { label: "Campagnes", desc: "Déploiements", icon: Megaphone, path: "/admin/academy/campaigns" },
    { label: "Suivi", desc: "Apprenants", icon: BarChart3, path: "/admin/academy/tracking" },
  ];
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/8 via-accent/5 to-transparent border p-6">
          <div className="flex items-center justify-between relative z-10">
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" onClick={() => navigate("/admin/academy/map")} className="gap-2">
                <Map className="h-4 w-4" /> Cartographie
              </Button>
              <Button size="sm" onClick={() => navigate("/admin/academy/paths")} className="gap-2">
