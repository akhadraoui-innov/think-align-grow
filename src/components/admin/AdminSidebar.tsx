...
export function AdminSidebar() {
  ...
  const systemItems = [
    ...
    { path: "/admin/emails", icon: Mail, label: "Email Studio", show: perms.hasAny("email.compose", "email.templates.manage", "email.automations.manage", "email.providers.manage", "email.logs.view") },
